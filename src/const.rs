...
pub const MATCH_SCORE: u8 = 4; // 1
pub const MISMATCH_PENALTY: u8 = 2; // -1,
pub const GAP_OPEN_PENALTY: u8 = 2; // -2
...
pub const CAPITALIZATION_BONUS: u8 = 1;
// bonus multiplier for the first character of the needle
pub const FIRST_CHAR_MULTIPLIER: u8 = 2;
