...
pub fn interleave_simd_generic<const W: usize, const L: usize>(strs: [&str; L]) -> [Simd<u16, L>; W]
where
...
mod tests {
    ...
    use super::interleave_simd_generic;
    ...
    fn test_interleave_simd_2() {
        let strs = ["ab", "cd"];
        let interleaved = interleave_simd_generic::<2, 2>(strs);
    ...
    fn test_interleave_simd_chunks_2() {
        let strs = ["abcd", "efgh"];
        let interleaved = interleave_simd_generic::<4, 2>(strs);
        assert_matrix_eq(
            interleaved,
    ...
    fn test_interleave_simd_4() {
        ...
        let interleaved = interleave_simd_generic::<4, 4>(strs);
        assert_matrix_eq(
            interleaved,
            [
                [b'a', b'e', b'i', b'm'],
    ...
    fn test_interleave_simd_8() {
        ...
        let interleaved = interleave_simd_generic::<8, 8>(strs);
