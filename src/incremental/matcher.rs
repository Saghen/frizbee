...
impl IncrementalMatcher {
    pub fn new<S: AsRef<str>>(haystacks: &[S]) -> Self {
        ...
        let mut collection_size_4 = IncrementalBucketCollection::<'_, u16, 4, 16>::new();
        let mut collection_size_8 = IncrementalBucketCollection::<'_, u16, 8, 16>::new();
        let mut collection_size_12 = IncrementalBucketCollection::<'_, u16, 12, 16>::new();
        let mut collection_size_16 = IncrementalBucketCollection::<'_, u16, 16, 16>::new();
        let mut collection_size_20 = IncrementalBucketCollection::<'_, u16, 20, 16>::new();
        let mut collection_size_24 = IncrementalBucketCollection::<'_, u16, 24, 16>::new();
