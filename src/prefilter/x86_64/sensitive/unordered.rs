...
// #[cfg(test)]
// mod tests {
//     use super::match_haystack_unordered;
//     use super::match_haystack_unordered_typos;
//
//     // TODO: extensive test suite
//     #[test]
//     fn test_prefilter_sse2_unordered() {
//         unsafe {
//             // assert!(match_haystack_unordered::<16>(b"test", b"test"));
//             // assert!(match_haystack_unordered::<16>(b"test", b"testt"));
//             // assert!(!match_haystack_unordered::<16>(b"test", b"te"));
//             // assert!(!match_haystack_unordered::<16>(b"test", b"t"));
//             // assert!(match_haystack_unordered::<16>(b"test", b"tes__t"));
//             assert!(match_haystack_unordered::<16>(b"test", b"_________test_"));
//
//             let str = "_".repeat(50) + "test";
//             assert!(match_haystack_unordered::<64>(b"test", str.as_bytes()));
//             let str = "_".repeat(50) + "tet";
//             assert!(!match_haystack_unordered::<64>(b"test", str.as_bytes()));
//         }
//     }
//
//     #[test]
//     fn test_prefilter_sse2_unordered_typos() {
//         unsafe {
//             let str = "_".repeat(50) + "tet";
//             assert!(match_haystack_unordered_typos::<64>(
//                 b"test",
//                 str.as_bytes(),
//                 1
//             ));
